...
export class PrivacyOperationsService {
  ...
  async deposit(
    ...
    await this.logs.append({
      kind: "deposit",
      message: `Deposited ${amountStroops.toString()} stroops`,
      fromAddress: account.publicKey,
  ...
  async transfer(input: {
    ...
    await this.logs.append({
      kind: "transfer",
      message: `Private transfer ${input.amountStroops.toString()} stroops`,
  ...
  async withdraw(
    ...
    await this.logs.append({
      kind: "withdraw",
      message: `Withdrew ${amountStroops.toString()} stroops`,
      fromAddress: account.publicKey,
